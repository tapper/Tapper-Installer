...
$EXECDIR/artemis_version_increment.pl $EXECDIR/../lib/Artemis/Installer.pm
cd $EXECDIR/..
...
ssh artemis@wotan 'echo "/home/artemis/perl510/bin/cpansite install Artemis::Installer" | bash -l'
